...
public class Registerer
{
    ...
    public void scan(Class<?> targetClass)
    {
        ...
        {
            thevault.registry.Register annotation = field.getAnnotation(thevault.registry.Register.class);
    ...
    private void registerItem(Side side, Field field, thevault.registry.Register annotation, Class<? extends Item> clazz)
    {
        try
        {
            Item item;
    ...
    private static String getName(thevault.registry.Register annotation)
    {
