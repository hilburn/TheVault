package hilburnlib.hilburnlib.registry;
...
public class Registerer
{
    ...
    public void scan(Class<?> targetClass)
    {
        ...
        {
            hilburnlib.registry.Register annotation = field.getAnnotation(hilburnlib.registry.Register.class);
    ...
    private void registerItem(Side side, Field field, hilburnlib.registry.Register annotation, Class<? extends Item> clazz)
    {
        try
        {
            Item item;
    ...
    private static String getName(hilburnlib.registry.Register annotation)
    {
